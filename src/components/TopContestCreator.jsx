...
export default function TopContestCreator() {
  ...
  return (
    <div className='my-24  w-full lg:max-w-[500px] mx-auto'>
      ...
      >
        {creators.map((creator, index) => (
          <SwiperSlide key={index} className="p-4 flex justify-center items-center">
            <div className="bg-white shadow-lg rounded-lg p-6 w-full text-center mx-auto border-t border-t-green-400">
              <img src={creator.image} alt={creator.name} className="w-24 h-24 rounded-full mx-auto mb-4 object-cover" />
              <h3 className="text-xl font-semibold mb-2">{creator.creatorName}</h3>
