...
export default function AddContest() {
  ...
  return (
    <div className="w-full lg:w-1/2 mx-auto">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="input input-bordered w-full"
          />
          {errors.prizeMoney && <span className="text-red-500">This field is required</span>}
        </div>
        <div>
        ...
        <div>
          ...
          <select {...register("contestType", { required: true })} defaultValue="" className="select select-bordered w-full">
          ...
          {errors.contestType && <span className="text-red-500">This field is required</span>}
        </div>
        <div>
      ...
      <button className="btn btn-block mt-4 text-white bg-[#00c1f1] text-lg">Submit</button>
